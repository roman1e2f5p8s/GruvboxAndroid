...
|----------|----------|------------------------|-------------------------|
| `dark0_hard`     | ![#1d2021](https://placehold.co/15x15/1d2021/1d2021.png) `#1d2021` | On Primary, On Secondary, On Tertiary, On Error, Surface Container Lowest | On Surface, On Background |
| `dark0`          | ![#282828](https://placehold.co/15x15/282828/282828.png) `#282828` | Surface, Surface Bright, Background | Inverse Surface, On Primary Container, On Primary Fixed, On Secondary Container, On Tertiary Container, On Secondary Fixed, On Tertiary Fixed |
| `dark0_soft`     | ![#32302f](https://placehold.co/15x15/32302f/32302f.png) `#32302f` | Inverse On Surface | On Surface Variant, On Primary Fixed Variant, On Secondary Fixed Variant, On Tertiary Fixed Variant |
| `dark1`          | ![#3c3836](https://placehold.co/15x15/3c3836/3c3836.png) `#3c3836` | Surface Container Low | - |
| `dark2`          | ![#504945](https://placehold.co/15x15/504945/504945.png) `#504945` | Surface Container, Surface Variant | Outline |
| `dark3`          | ![#665c54](https://placehold.co/15x15/665c54/665c54.png) `#665c54` | Surface Container High | - |
| `dark4`          | ![#7c6f64](https://placehold.co/15x15/7c6f64/7c6f64.png) `#7c6f64` | Surface Container Highest | Surface Dim |
| | | | |
| `gray_245`       | ![#928374](https://placehold.co/15x15/928374/928374.png) `#928374` | Outline Variant | Outline Variant |
| | | | |
| `light0_hard`    | ![#f9f5d7](https://placehold.co/15x15/f9f5d7/f9f5d7.png) `#f9f5d7` | On Surface, On Background | On Primary, On Secondary, On Tertiary, On Error, Surface Container Lowest |
...
| | | | |
| `neutral_red`    | ![#cc241d](https://placehold.co/15x15/cc241d/cc241d.png) `#cc241d` | On Error Container | Error |
| `neutral_green`  | ![#98971a](https://placehold.co/15x15/98971a/98971a.png) `#98971a` | Secondary Fixed Dim | Secondary |
| `neutral_yellow` | ![#d79921](https://placehold.co/15x15/d79921/d79921.png) `#d79921` | - | Primary Container, Primary Fixed, Inverse Primary |
| `neutral_blue`   | ![#458588](https://placehold.co/15x15/458588/458588.png) `#458588` | Secondary | Tertiary |
| `neutral_purple` | ![#b16286](https://placehold.co/15x15/b16286/b16286.png) `#b16286` | Tertiary | Tertiary Container, Tertiary Fixed |
| `neutral_aqua`   | ![#689d6a](https://placehold.co/15x15/689d6a/689d6a.png) `#689d6a` | Primary | Secondary Container, Secondary Fixed |
| `neutral_orange` | ![#d65d0e](https://placehold.co/15x15/d65d0e/d65d0e.png) `#d65d0e` | Tertiary Container, Tertiary Fixed | Primary |
| | | | |
| `faded_red`      | ![#9d0006](https://placehold.co/15x15/9d0006/9d0006.png) `#9d0006` | - | On Error Container |
| `faded_green`    | ![#79740e](https://placehold.co/15x15/79740e/79740e.png) `#79740e` | Secondary Container, Secondary Fixed | - |
| `faded_yellow`   | ![#b57614](https://placehold.co/15x15/b57614/b57614.png) `#b57614` | - | Primary Fixed Dim |
| `faded_blue`     | ![#076678](https://placehold.co/15x15/076678/076678.png) `#076678` | Primary Container, Primary Fixed, Inverse Primary | - |
| `faded_purple`   | ![#8f3f71](https://placehold.co/15x15/8f3f71/8f3f71.png) `#8f3f71` | - | Tertiary Fixed Dim |
| `faded_aqua`     | ![#427b58](https://placehold.co/15x15/427b58/427b58.png) `#427b58` | - | Secondary Fixed Dim |
| `faded_orange`   | ![#af3a03](https://placehold.co/15x15/af3a03/af3a03.png) `#af3a03` | - | - |
| | | | |
| `black`          | ![#000000](https://placehold.co/15x15/000000/000000.png) `#000000` | Scrim, Shadow | Scrim, Shadow, Surface Tint |
| `white`          | ![#ffffff](https://placehold.co/15x15/ffffff/ffffff.png) `#ffffff` | Surface Tint | - |

### How does it look like?

- Dark mode
![Dark mode](./colors/Gruvbox-Dark.png)
- Light mode
![Dark mode](./colors/Gruvbox-Light.png)
